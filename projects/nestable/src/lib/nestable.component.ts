        ...
        if (!this._mouse.dirAx || isNewRoot) {
            ...
            if (this.options.fixedDepth) {
                if (pointRelativeDepth === this.relativeDepth - 1) {
                    ...
                    if (!childList[this.options.childrensKey].length) {
        ...
        if (this.dragEl) {
            ...
            if (placeholderContainer === null) {
                ...
                placeholderContainer = helper._findObjectInTree(
                    ...
                    this.options.childrensKey
                );
                if (!placeholderContainer[this.options.childrensKey]) {
                    placeholderContainer[this.options.childrensKey] = [];
                    placeholderContainer[this.options.childrensKey].push({ ...this.dragModel });
                } else {
                    placeholderContainer[this.options.childrensKey].splice(
                        Array.prototype.indexOf.call(
                            this._placeholder.parentElement.children,
                            this._placeholder
                        ),
